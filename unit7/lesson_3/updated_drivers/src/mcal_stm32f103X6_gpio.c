...
void MCAL_GPIO_Init (S_GPIO_t *GPIOx, GPIO_Pin_Config_t* PinConfig)
{
 ...
 * Note			-none
 */
void MCAL_GPIO_DeInit (S_GPIO_t *GPIOx)
{
 ...
 * Note			-none
 */
uint8_t MCAL_GPIO_ReadPin (S_GPIO_t *GPIOx,uint16_t PinNumber )
{
	uint8_t bitstatus ;
 ...
 * Note				-none
 */
void MCAL_GPIO_WritePin (S_GPIO_t *GPIOx,uint16_t PinNumber , uint8_t Value)
{
	if ( Value !=  LOW )
	{
//		GPIOx->ODR |= PinNumber ;
 ...
 * Note				-none
 */
void MCAL_GPIO_TogglePin (S_GPIO_t *GPIOx,uint16_t PinNumber )
{
	GPIOx->ODR ^= (PinNumber) ;
}
/**================================================================
 ...
 * Note				-none
 */
uint8_t MCAL_GPIO_LockPin (S_GPIO_t *GPIOx,uint16_t PinNumber )
{
...
void MCAL_GPIO_SET_Pin(S_GPIO_t *GPIOport, uint16_t Pin_number, uint8_t mode, uint8_t speed)
{
    ...
    GPIOx.GPIO_Pin_Number = Pin_number;
    GPIOx.GPIO_Mode = mode;
    GPIOx.GPIO_OUTPUT_Speed = speed;
    MCAL_GPIO_Init(GPIOport, &GPIOx);
}
