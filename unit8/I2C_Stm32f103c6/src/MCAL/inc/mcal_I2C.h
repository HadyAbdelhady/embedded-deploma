...
void MCAL_SPI_INIT(S_I2C_t *I2Cx, I2C_Config_t *I2C_Config);
void MCAL_I2C_RESET(S_I2C_t *I2Cx);
...
void I2C_GenerateStart(S_I2C_t *I2Cx,START_Condition Start, Functional_State State);
void I2C_SendAddress(S_I2C_t *I2Cx, uint16_t Device_Address,I2C_Direction Direction);
