...
// RESET SPI Clock
#define RCC_SPI1_RESET (RCC->RCC_APB2ENR |= 1 << 12)
#define RCC_SPI2_RESET (RCC->RCC_APB1ENR |= 1 << 14)
#define RCC_SPI3_CLK_EN (RCC->RCC_APB1ENR |= 1 << 15)
...
#define NVIC_IRQ15_SPI3_ENABLE (NVIC_ISER1 |= 1 << SPI3_IRQ)
...
#define NVIC_IRQ15_SPI3_DISABLE (NVIC_ICER1 |= 1 << SPI3_IRQ)
